                    ...
                    builder: (BuildContext context) {
                      return BaseDialog(
                        ...
                        child: const Padding(
                          ...
                          child:
                              Text("你确定要清空记录吗？", textAlign: TextAlign.center),
                        ),
                        onPressed: () async {
                          ...
                          try {
                            BaseEntity<bool> res =
                                await MyRepository.deleteAllView();
                            overlayEntry.remove();
                            if (res.code == 1000) {
                              Toast.show('删除成功');
      ...
      body: EasyRefresh(
        ...
        onRefresh: () async {
          BaseEntity<DataPageEntity> res =
              await MyRepository.getHistoryDataPage(1, 10);
          if (res.code != 1000) {
            Toast.show(res.message);
            return;
          }
        ...
        onLoad: () async {
          _page++;
          BaseEntity<DataPageEntity> res =
              await MyRepository.getHistoryDataPage(_page, 10);
          if (res.code != 1000) {
            Toast.show(res.message);
            return;
          }
