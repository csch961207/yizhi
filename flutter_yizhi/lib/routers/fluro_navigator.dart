...
class NavigatorUtils {
  ...
  /// 跳转到作者页面
  static void goAuthor(
      BuildContext context, int userId, String author, String avatar) {
    push(context,
        '${HomeRouter.authorPage}?userId=$userId&author=${Uri.encodeComponent(author)}&avatar=${Uri.encodeComponent(avatar)}');
  }
